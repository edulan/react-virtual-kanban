!function(root, factory) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        _reactDndScrollzone.createHorizontalStrength)(200), getDndContext = function() {
            ...
            function Kanban(props) {
                ...
                _this.onDragEndRow = _this.onDragEndRow.bind(_this), _this.renderList = _this.renderList.bind(_this), 
                _this;
            }
            return _inherits(Kanban, _Component), _createClass(Kanban, [ {
                ...
                value: function(_ref3) {
                    var rowId = _ref3.rowId, rowIndex = (_ref3.listId, _ref3.rowIndex), listIndex = _ref3.listIndex;
                    this.props.onDragEndRow({
                        rowId: rowId,
                        listId: this.state.lists[listIndex].id,
                        rowIndex: rowIndex,
                        listIndex: listIndex
                    });
                }
                ...
                value: function(_ref4) {
                    var rowId = _ref4.rowId, listId = _ref4.listId, rowIndex = _ref4.rowIndex, listIndex = _ref4.listIndex;
                    this.props.onDropRow({
                        rowId: rowId,
                        listId: listId,
                        rowIndex: rowIndex,
                ...
                value: function(_ref5) {
                    var columnIndex = _ref5.columnIndex, style = (_ref5.key, _ref5.style), list = this.state.lists[columnIndex];
	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(2), _react2 = _interopRequireDefault(_react), _reactAddonsShallowCompare = __webpack_require__(3), _reactAddonsShallowCompare2 = _interopRequireDefault(_reactAddonsShallowCompare), ItemPreview = (__webpack_require__(178), 
        function(_Component) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(2), _react2 = _interopRequireDefault(_react), _reactAddonsShallowCompare = __webpack_require__(3), _reactAddonsShallowCompare2 = _interopRequireDefault(_reactAddonsShallowCompare), ListPreview = (__webpack_require__(178), 
        function(_Component) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(2), _react2 = _interopRequireDefault(_react), _reactAddonsShallowCompare = __webpack_require__(3), _reactAddonsShallowCompare2 = _interopRequireDefault(_reactAddonsShallowCompare), _reactDnd = __webpack_require__(183), _reactDndHtml5Backend = __webpack_require__(4), _types = (__webpack_require__(178), 
        __webpack_require__(322)), _dragSpec = __webpack_require__(326), dragSpec = _interopRequireWildcard(_dragSpec), _dropSpec = __webpack_require__(350), dropSpec = _interopRequireWildcard(_dropSpec), SortableItem = function(_Component) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        function endDrag(props, monitor) {
            var _monitor$getItem = monitor.getItem(), row = _monitor$getItem.row, rowId = _monitor$getItem.rowId, rowIndex = _monitor$getItem.rowIndex, listIndex = _monitor$getItem.listIndex;
            props.dragEndRow({
                row: row,
                rowId: rowId,
                rowIndex: rowIndex,
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.beginDrag = beginDrag, exports.isDragging = isDragging, exports.endDrag = endDrag;
