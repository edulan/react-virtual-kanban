    ...
    value: function renderItem(type, item) {
      ...
      switch (type) {
        case ItemTypes.ROW_TYPE:
          ...
          return _react2.default.createElement(Preview, { rowId: item.rowId, rowStyle: item.rowStyle, containerWidth: item.containerWidth });
        case ItemTypes.LIST_TYPE:
          Preview = this.props.listPreviewComponent;

          return _react2.default.createElement(Preview, { listId: item.listId, listStyle: item.listStyle });
        default:
          return null;
      }
    }
