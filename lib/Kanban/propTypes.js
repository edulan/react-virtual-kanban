...
var scrollToColumn = exports.scrollToColumn = _react.PropTypes.number;
var scrollToRow = exports.scrollToRow = _react.PropTypes.number; // Kanban is a single row grid, so this is intended for SortabeList's scrollToIndex
var scrollToAlignment = exports.scrollToAlignment = _react.PropTypes.string; // row and column share this alignment
